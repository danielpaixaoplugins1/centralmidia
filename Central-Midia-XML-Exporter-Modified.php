...
function enqueue_datepicker() {
    // Enqueue jQuery UI and its stylesheet for the datepicker
    wp_enqueue_script('jquery-ui-datepicker');
    wp_enqueue_style('jquery-ui-css', 'https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css');
}
add_action('admin_enqueue_scripts', 'enqueue_datepicker');

add_action('admin_footer', 'add_datepicker_init_script');
function add_datepicker_init_script() {
    ?>
    <script type="text/javascript">
    
jQuery(document).ready(function($) {
    // Targeting input fields by name attribute for datepicker initialization
    $('input[name="post_start_date"], input[name="post_end_date"], input[name="page_start_date"], input[name="page_end_date"], input[name="attachment_start_date"], input[name="attachment_end_date"]').datepicker();
});
